...
layui.config({
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        for(var i=0;i<newsData.length;i++){
                            ...
                            if(newsStr.msg.indexOf(selectStr) > -1){
                                newsStr["msg"] = changeStr(newsStr.msg);
                            }
                            if(newsStr.msg.indexOf(selectStr)>-1 ){
    ...
    $(".newsAdd_btn").click(function(){
        var index = layui.layer.open({
            title : "添加广播",
            type : 2,
            content : "admin_add_broadcast.jsp",
